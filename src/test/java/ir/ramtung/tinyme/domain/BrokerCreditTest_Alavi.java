...
public class BrokerCreditTest {
    ...
    void update_buy_iceberg() {
        ...
        EnterOrderRq updateOrderRq = EnterOrderRq.createUpdateOrderRq(1, security.getIsin(), 11,
    ...
    void update_sell_iceberg() {
        ...
        EnterOrderRq updateOrderRq = EnterOrderRq.createUpdateOrderRq(1, security.getIsin(), 12,
    ...
    void update_buy_iceberg_quantity() {
        IcebergOrder order1 = new IcebergOrder(11, security, Side.BUY, 1000, 12000, buyer, shareholder, 50);
        IcebergOrder order2 = new IcebergOrder(12, security, Side.SELL, 1000, 15700, seller, shareholder, 50);
        security.getOrderBook().enqueue(order1);
        security.getOrderBook().enqueue(order2);
